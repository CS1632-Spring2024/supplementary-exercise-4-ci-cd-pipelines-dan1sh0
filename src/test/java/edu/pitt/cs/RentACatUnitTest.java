...
public class RentACatUnitTest {
	...
	public void testGetCatNullNumCats0() {
		// TODO: Fill in
		try {
			// makes getCat() accessible
			Method m = r.getClass().getDeclaredMethod("getCat", int.class);
			m.setAccessible(true);

			Cat ret = (Cat) m.invoke(r, 2);	// getCat(2)
			assertNull(ret);

			// check system output
			String expectedString = "Invalid cat ID." + newline;
	...
	/**
	 * Test case for String listCats			fail();
().
	 * 
	 * <pre>
	 * Preconditions: r has no cats.
	...
	public void testListCatsNumCats3() {
		...
		String retString = r.listCats();
		String expectString = "ID 1. Jennyanydots\nID 2. Old Deuteronomy\nID 3. Mistoffelees\n";
		assertEquals(expectString, retString);
	}
	...
	public void testRenameFailureNumCats0() {
		...
		// verifies renameCat wasn't called on c2
	...
	public void testRenameNumCat3() {
		...
		// verifies renameCat was called on c2
	...
	public void testRentCatNumCats3() {
		...
		// verifies rentCat was called on c2
		Mockito.verify(c2).rentCat();

		// check system output
		String expectedString = "Old Deuteronomy has been rented." + newline;
        assertEquals(expectedString, out.toString());
	}
	...
	public void testRentCatFailureNumCats3() {
		...
		// verifies getRented is called twice
		Mockito.verify(c2, times(2)).getRented();

		// check system output
		String expectedString = "Sorry, Old Deuteronomy is not here!" + newline;
        assertEquals(expectedString, out.toString());
	}
	...
	public void testReturnCatNumCats3() {
		...
		// verifies returnCat is called once
		Mockito.verify(c2, times(1)).returnCat();

		// check system output
		String expectedString = "Welcome back, Old Deuteronomy!" + newline;
        assertEquals(expectedString, out.toString());
	}
	...
	public void testReturnFailureCatNumCats3() {
		...
		// verifies returnCat is never called
		Mockito.verify(c2, never()).returnCat();

		// check system output
		String expectedString = "Old Deuteronomy is already here!" + newline;
        assertEquals(expectedString, out.toString());
	}
